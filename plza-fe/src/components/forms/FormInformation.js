...
export const locationRegisterFields = [
    {name: 'business_name', icon: 'building', label: "Business Name", placeholder: "Business Name", content: 'Business Name is required'},
    {name: 'first_name', icon: 'user circle', label: "First Name", placeholder: "First Name", content: 'Enter in your first name', required: false},
    {name: 'last_name', icon: 'user circle', label: "Last Name", placeholder: "Last Name", content: 'Enter in your last name', required: false},
    {name: 'address', icon: "location arrow", label: 'Street Address', placeholder: '123 Pizza Pie Ln, Somewhere, TX 12345', content: 'Street address is required'},
    {name: 'website_url', icon: 'computer', label: "Website URL", placeholder: "https://example.com", content: 'Enter in your website url', required: false}
]
